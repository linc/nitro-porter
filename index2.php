...
include_once 'database/interface.databaseabstraction.php';
include_once 'database/class.mysqldatabase.php.php';
include_once 'database/class.mysqlidatabase.php.php';
